...
- Our overall definition of  <img src="https://render.githubusercontent.com/render/math?math=S"> is  <img src="https://render.githubusercontent.com/render/math?math=S = \{x \mid x \in \mathbb{Z}, x \geq 0\}"> . In other words,  <img src="https://render.githubusercontent.com/render/math?math=S"> contains all instances of x such that x is an integer and x is greater than or equal to zero.
